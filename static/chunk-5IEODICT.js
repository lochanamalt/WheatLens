      ...
      if ((dr == null ? void 0 : dr.enabled) && this.isMultiFormat() && Array.isArray(rawStash) && rawStash.length > ((_c = dr.threshold) != null ? _c : 500)) {
        ...
        if (windowed.length > targetPoints) {
          ...
          if (Array.isArray(sampleY)) {
            if (sampleY.length === 4) {
              reduced = _Data.ohlcAggregate(windowed, targetPoints);
            }
          } else {
            reduced = _Data.lttbDownsample(windowed, targetPoints);
          }
        }
...
apexcharts/dist/core.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5IEODICT.js.map
